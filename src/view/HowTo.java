...
public class HowTo extends JPanel implements ActionListener{
	...
	public HowTo( GameFrame frame, Music music ) {
		this.frame = frame;
		this.music = music;
		setHowTo();
		components();
	...
	public void components(){
		...
		background = new JLabel( new ImageIcon( "Images/howTo/howToBg.png" ) );
	...
	public void actionPerformed( ActionEvent e ) {
		if( e.getSource() == x ){
			t2 = new Timer(1, new HowToCloser() );
			t2.start();
		}
	...
	public class HowToCloser implements ActionListener{

		@Override
		public void actionPerformed( ActionEvent e ) {
			frame.howTo.setBounds( 0, i-=2, 800, 600 );
			if( i == -600 ){
				t2.stop();
				music.music2.stop();
